...
import { CALENDAR_ACTIVE, CALENDAR_DAYS } from "@/lib/data";
    ...
    <div className="min-w-0 flex-[1_1_340px] border-l-2 border-divider bg-surface p-7 sm:p-10">
      ...
      <div className="rounded-lg border border-divider bg-bg p-5">
        <div className="mb-3.5 flex items-baseline justify-between">
          <span className="font-heading text-[15px] font-bold">October 2026</span>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  color: active ? "var(--color-bg)" : "color-mix(in srgb, var(--color-text) 55%, transparent)",
                }}
              >
                {day}
              </div>
        ...
        <div className="flex flex-col gap-2 border-t border-divider pt-3.5">
          <div className="flex justify-between text-[13px]">
            <span>Tue 06 Oct</span>
            <span className="text-accent-300">3 slots</span>
          </div>
          <div className="flex justify-between text-[13px]">
            <span>Thu 08 Oct</span>
            <span className="text-accent-300">5 slots</span>
          </div>
        </div>
      </div>
      <Button href="/#book" variant="primary" className="mt-4 w-full justify-start px-4! py-3! text-sm!">
        Pick a time
      </Button>
      <p className="mt-3 text-xs text-text/58">Opens our live calendar - pick any open slot.</p>
    </div>
  );
}
